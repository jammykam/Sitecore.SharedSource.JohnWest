namespace Sitecore.Sharedsource.Mvc.Pipelines.Response.GetRenderer
{
  ...
  public class GetXsltRenderer : SC.Mvc.Pipelines.Response.GetRenderer.GetXsltRenderer
  {
      ...
      SC.Mvc.Pipelines.Response.GetRenderer.GetRendererArgs args)
    {
      ...
      return new SC.Sharedsource.Mvc.Presentation.XsltRenderer { Path = xsltPath, Rendering = rendering };
    }
  }
}